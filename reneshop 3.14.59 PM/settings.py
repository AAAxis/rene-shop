...
ALL_COUNTRY_CODES = [
    ...
    'BT', 'BV', 'BW', 'BZ', 'CA', 'CD', 'CF', 'CG', 'CH', 'CI', 'CK', 'CL', 'CM', 'CN', 'CO', 
    ...
    'RE', 'RO', 'RS', 'RW', 'SA', 'SB', 'SC', 'SE', 'SG', 'SH', 'SI', 'SJ', 'SK', 'SL', 'SM', 
...
GS_BUCKET_NAME = 'portfolio-nnnocturn'  # Replace 'your-bucket-name' with your actual bucket name

GS_CREDENTIALS = service_account.Credentials.from_service_account_file(
    os.path.join(BASE_DIR, 'service_account.json')
)

GS_LOCATION = "project-img"
